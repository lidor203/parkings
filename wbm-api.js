...
const { from, merge } = require('wbm/node_modules/rxjs');
const { take } = require('wbm/node_modules/rxjs/operators');
...
async function sendTo(phoneOrContact, message) {
    ...
    try {
        ...
        await page.waitForSelector(SELECTORS.SEND_BUTTON, { timeout: 60000 });
        ...
        readline.clearLine(process.stdout);
        readline.cursorTo(process.stdout, 0);
        process.stdout.write(`Failed with error: ${err}\n`);
        counter.fails++;
    }
}
